...
.controller('HomeCtrl',['$scope','categoryManager','$ionicSlideBoxDelegate','$timeout','$ionicSideMenuDelegate','AuthService',function($scope,categoryManager,$ionicSlideBoxDelegate,$timeout,$ionicSideMenuDelegate,AuthService) {
